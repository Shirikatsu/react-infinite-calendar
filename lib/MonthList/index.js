...
process.env.NODE_ENV !== "production" ? MonthList.propTypes = {
  ...
  unavailableDates: _propTypes2.default.arrayOf(_propTypes2.default.string),
  availableDates: _propTypes2.default.arrayOf(_propTypes2.default.string),
  fewSlotsDates: _propTypes2.default.arrayOf(_propTypes2.default.string),
