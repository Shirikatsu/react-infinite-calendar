...
process.env.NODE_ENV !== "production" ? Calendar.propTypes = {
  ...
  unavailableDates: _propTypes2.default.arrayOf(_propTypes2.default.instanceOf(Date)),
  manySlotsDates: _propTypes2.default.arrayOf(_propTypes2.default.instanceOf(Date)),
  fewSlotsDates: _propTypes2.default.arrayOf(_propTypes2.default.instanceOf(Date)),
  ...
  theme: _propTypes2.default.shape({
    ...
    dayFullColor: _propTypes2.default.string,
    dayAvailableColor: _propTypes2.default.string,
    dayFillingColor: _propTypes2.default.string,
